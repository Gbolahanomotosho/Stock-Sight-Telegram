# main.py — Fixed Google Sheets Integration with Proper Persistence
import os
import io
import math
import asyncio
...
VERSION = "Stock Sight Telegram Service v2.2 (Fixed Persistence)"
...
class GoogleSheetsManager:
    ...
    def _initialize(self):
        ...
        try:
            ...
            try:
                ...
                # CRITICAL FIX: Verify and fix headers
    ...
    def _ensure_headers(self):
        ...
        try:
            ...
            if first_row != expected_headers:
                ...
                # If first row looks like user data (starts with numeric user_id)
                if all_data and all_data[0] and all_data[0][0].isdigit():
                    ...
                    # Just update first row with headers
    ...
    def load_subscriptions(self) -> Dict[str, Any]:
        ...
        try:
            # Get all records (skip header row automatically)
    ...
    def save_subscription(self, user_id: int, data: Dict[str, Any], 
        ...
        if not self.enabled or not self.worksheet:
            print("[WARN] Google Sheets not enabled, cannot save")
            return False
        ...
        try:
            ...
            try:
                ...
                # Verify it's not the header row
                if cell and cell.row == 1:
                    cell = None  # Treat as not found
...
def _save_subs(subs: Dict[str, Any]) -> None:
    ...
    # Always save to local JSON first (for reliability)
    try:
