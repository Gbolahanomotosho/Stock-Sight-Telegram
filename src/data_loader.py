...
TICKER_MAPPING = {
    ...
    "ETHUSDT": {"yahoo": "ETH-USD"},
    "DOGEUSDT": {"yahoo": "DOGE-USD"},
    "LTCUSDT": {"yahoo": "LTC-USD"},
    "TRXUSDT": {"yahoo": "TRX-USD"},
    #Others
    "HFTUSDT": {"yahoo": "HFT-USD"},
    "BOOMUSDT": {"yahoo": "BOOM-USD"},
    "RICEUSDT": {"yahoo": "RICE3-USD"},
    "SOLUSDT": {"yahoo": "SOL-USD"},
    "XRPUSDT": {"yahoo": "XRP-USD"},
    "BNBUSDT": {"yahoo": "BNB-USD"},
    "USDCUSDT": {"yahoo": "USDC-USD"},

    
    "NZD/CAD": {"yahoo": "NZDCAD=X"},
    "NZD/JYP": {"yahoo": "NZDJYP=X"},
    "AUD/CAD": {"yahoo": "AUDCAD=X"},
    "AUD/USD": {"yahoo": "AUDUSD=X"},
    "GBP/JYP": {"yahoo": "GBPJYP=X"},
    "GBP/USD": {"yahoo": "GBPUSD=X"},

    "NZDCAD": {"yahoo": "NZDCAD=X"},
    "NZDJYP": {"yahoo": "NZDJYP=X"},
    "AUDCAD": {"yahoo": "AUDCAD=X"},
    "AUDUSD": {"yahoo": "AUDUSD=X"},
    "GBPJYP": {"yahoo": "GBPJYP=X"},
    "GBPUSD": {"yahoo": "GBPUSD=X"},

    "NZDUSD": {"yahoo": "NZDUSD=X"},
    "JYPUSD": {"yahoo": "JYPUSD=X"},
...
def normalize_ticker(ticker: str, provider: Optional[str] = "yahoo") -> str:
    ...
    if ticker.isupper() and len(ticker) in (6, 7):
        ...
        if ticker.endswith("USD") or ticker.endswith("JPY") or ticker.endswith("EUR") or ticker.endswith("GBP"):
